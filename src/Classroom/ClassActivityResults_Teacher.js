...
function ClassActivityResults_Teacher() {
                           ...
                           >
                              ...
                              >
                                 ...
                                 <div className="activityname">
                                    <div className="titileASNedit">ชื่อ <div className="titleASN">{a.title}</div></div>
                                 </div>
                                 <div />
                                 <Grid item xs={6}>
                                    <div className="questionASN">
                                       <div className="questionASNedit">คำถาม <br className="newline" /><div className="questionASN">{a.description}</div></div>
                                    </div>
                                 </Grid>
                                 <Grid item xs={6}>
                                    <div className="activityduedate">
                                       <div className="datetimeASNedit">
                                          สิ้นสุดวันที่ <br className="newline" />{date}
                                       </div>
                                    </div>
                                 </Grid>
                                 <Grid item xs={6}>
                                 ...
                                 <Grid item xs={6}>
                                    <div className="textinbutton">เลือก {a.choice_true}</div>
                                 </Grid>
                                 <Grid item xs={6}>
                                    <div className="textinbutton">4</div>
                                 </Grid>
                                 <Grid item xs={6}>
                                    <div className="textinbutton">เลือก {a.choice_false}</div>
                                 </Grid>
                                 <Grid item xs={6}>
   ...
   const handleDeleteASN = () => {
      ...
      setTimeout(() => {
         ...
         navigate("/reload")
         setTimeout(() => { navigate("/classroom-activity", { replace: true }) }, 20);
      }, 3000)
      handleClose()
   }
   ...
   const clickPopupEdit = (title, description, choice_true, choice_false, deadline, id) => {
      setEditASNID(id)
